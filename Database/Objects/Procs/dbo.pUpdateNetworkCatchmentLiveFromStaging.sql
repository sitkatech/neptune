...
When not matched by Target
	Then insert (DrainID, Watershed, CatchmentGeometry, OCSurveyCatchmentID, OCSurveyDownstreamCatchmentID, CatchmentGeometry4326, LastUpdate)
		values(s.DrainID, s.Watershed, s.CatchmentGeometry, s.OCSurveyCatchmentID, s.OCSurveyDownstreamCatchmentID, null, GetDate())
