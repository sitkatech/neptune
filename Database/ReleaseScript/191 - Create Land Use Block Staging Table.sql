CREATE TABLE dbo.LandUseBlockStaging(
	...
	StormwaterJurisdiction varchar(255) NULL,
	PermitType varchar(255),
	UploadedByPersonID int Null Constraint FK_LandUseBlockStaging_Person_UploadedByPersonID_PersonID Foreign Key References dbo.Person (PersonID) 
)