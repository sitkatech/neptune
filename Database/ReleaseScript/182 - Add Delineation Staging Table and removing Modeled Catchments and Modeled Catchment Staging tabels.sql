...
DelineationGeometryStagingID int not null identity(1,1) constraint PK_DelineationStaging_DelineationStagingID primary key,
...
DelineationGeometryStagingGeoJson varchar(max) not null,
