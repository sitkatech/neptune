...
create table dbo.WaterQualityManagementPlan(
	...
	WaterQualityManagementPlanStatusID int not null constraint FK_WaterQualityManagementPlan_WaterQualityManagementPlanStatus_WaterQualityManagementPlanStatusID foreign key references dbo.WaterQualityManagementPlanStatus(WaterQualityManagementPlanStatusID),
	WaterQualityManagementPlanDevelopmentTypeID int not null constraint FK_WaterQualityManagementPlan_WaterQualityManagementPlanDevelopmentType_WaterQualityManagementPlanDevelopmentTypeID foreign key references dbo.WaterQualityManagementPlanDevelopmentType(WaterQualityManagementPlanDevelopmentTypeID),
