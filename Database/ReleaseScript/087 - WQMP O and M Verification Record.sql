...
CREATE TABLE WaterQualityManagementPlanVerify (
	...
	LastEditedByPersonID INT NULL CONSTRAINT FK_WaterQualityManagementPlanVerify_Person_LastEditedByPersonID_PersonID FOREIGN KEY REFERENCES dbo.Person (PersonID),
