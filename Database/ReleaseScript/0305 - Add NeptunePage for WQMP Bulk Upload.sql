...
<p><strong>The CSV should follow this format:</strong></p> <p><table align="left" border="1">  <tbody>   <tr>    <td><strong>Required Properties</strong></td>   </tr>   <tr>    <td> WQMP Name, Jurisdiction, Land Use, Priority, Status, Development Type, Trash Capture Status</td>   </tr>  <tr>    <td><strong>Optional Properties</strong></td> </tr> <tr> <td>Maintenance Contact Name, Maintenance Contact Organization, Maintenance Contact Phone, Maintenance Contact Address 1, Maintenance Contact Address 2, Maintenance Contact City, Maintenance Contact State, Maintenance Contact Zip, Permit Term, Hydromodification Controls Apply, Approval Date, Date of Construction, Hydrologic Subarea, Record Number, Recorded WQMP Area (Acres)</td>   </tr> </tbody> </table> </p>
')
