...
ALTER TABLE dbo.OnlandVisualTrashAssessmentArea DROP CONSTRAINT FK_OnlandVisualTrashAssessmentArea_OnlandVisualTrashAssessmentScore_OnlandVisualTrashAssessmentScoreID
...
Add OnlandVisualTrashAssessmentProgressScoreID Int Null Constraint FK_OnlandVisualTrashAssessmentArea_OnlandVisualTrashAssessmentScore_OnlandVisualTrashAssessmentProgressScoreID_OnlandVisualTrash FOREIGN KEY(OnlandVisualTrashAssessmentProgressScoreID)
REFERENCES dbo.OnlandVisualTrashAssessmentScore (OnlandVisualTrashAssessmentScoreID)
