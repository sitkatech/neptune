...
(80, 'Design Low Flow Diversion Capacity', 'Design Low Flow Diversion Capacity', 'The physical capacity of the low flow diversion or the maximum permitted flow.', 1),
(81, 'Design Media Filtration Rate', 'Design Media Filtration Rate', 'Design filtration rate through the media bed. This may be controlled by the media permeability or by an outlet control on the underdrain system.', 1),
(82, 'Design Residence Time for Permanent Pool', 'Design Residence Time for Permanent Pool', 'Amount of residence time needed to meet full level of treatment for water that is stored in the permanent pool.', 1),
(83, 'Diversion Rate', 'Diversion Rate', 'Flowrate diverted into the BMP.', 1),
(84, 'Drawdown Time for WQ Detention Volume', 'Drawdown Time for WQ Detention Volume', 'Time for water quality surcharge volume to draw down after the end of a storm if there is no further inflow.', 1),
(85, 'Effective Footprint', 'Effective Footprint', 'The footprint of the BMP that is effective for filtration or infiltration. Unless other information is available, this can be estimated as the wetted footprint when BMP is half full.', 1),
(86, 'Effective Retention Depth', 'Effective Retention Depth', 'Depth of water stored in shallow surface depression or media/rock sump for infiltration to occur.', 1),
(87, 'Infiltration Discharge Rate', 'Infiltration Discharge Rate', 'Design or tested infiltration flowrate of the drywell. This is specified in cubic feet per section, rather than inches per hour.', 1),
(88, 'Infiltration Surface Area', 'Infiltration Surface Area', 'Surface area through which infiltration can occur in the system. If infiltration will occur into the sidewalls of a BMP, it is appropriate to include half of the sidewall area as as part of the infiltration surface area.', 1),
(89, 'Media Bed Footprint', 'Media Bed Footprint', 'Surface area of the media bed of the BMP.', 1),
(90, 'Months of Operation', 'Months of Operation', 'This defines the months that the facility is operational.', 1),
(91, 'Permanent Pool or Wetland Volume', 'Permanent Pool or Wetland Volume', 'Volume of water below the lowest surface outlet. Serves as a wetland or permanent pool. Water may be harvested from this pool. ', 1),
(92, 'Routing Configuration', 'Routing Configuration', 'This specifies whether the BMP receives all flow from the drainage area (online), or if there is a diversion structure that limits the flow into the BMP (offline).', 1),
(93, 'Storage Volume Below Lowest Outlet Elevation', 'Storage Volume Below Lowest Outlet Elevation', 'The volume of water stored below the lowest outlet (e.g., underdrain, orifice) of the system.', 1),
(94, 'Summer Harvested Water Demand', 'Summer Harvested Water Demand', 'Average daily harvested water demand from May through October.', 1),
(95, 'Time of Concentration', 'Time of Concentration', 'The time required for the entire drainage to begin contributing runoff to the BMP. This value must be less than 60 minutes. See TGD guidance.', 1),
(96, 'Total Drawdown Time', 'Total Drawdown Time', 'Time for the basin to fully draw own after the end of a storm if there is no further inflow.', 1),
(97, 'Total Effective BMP Volume', 'Total Effective BMP Volume', 'The volume of the BMP available for water quality purposes. This includes ponding volume and the available pore volume in media layers and/or in gravel storage layers. It does not include flow control volumes or other volume that is not designed for water quality purposes. ', 1),
(98, 'Total Effective Drywell BMP Volume', 'Total Effective Drywell BMP Volume', 'The volume of the BMP available for water quality purposes. This includes the volume in any pre-treatment chamber as well as the volume in the well itself.', 1),
(99, 'Treatment Rate', 'Treatment Rate', 'The flowrate at which the BMP can provide treatment of runoff.', 1),
(100, 'Underlying Hydrologic Soil Group (HSG)', 'Underlying Hydrologic Soil Group (HSG)', 'Choose the soil group that best represents the soils underlying the BMP. This is used to estimate a default infiltration rate (A = XX, B = XX, C=XX, D=XX)', 1),
(101, 'Underlying Infiltration Rate', 'Underlying Infiltration Rate', 'The underlying infiltration rate below the BMP. This refers to the underlying soil, not engineered media.', 1),
(102, 'Upstream BMP', 'Upstream BMP', 'Assign a delineation to the BMP through the normal delineation options.<br /><br />OR<br /><br />Indicate that the BMP receives flow from an upstream BMP.', 1),
(103, 'Water Quality Detention Volume', 'Water Quality Detention Volume', 'Volume of water above the surface outlet that provides a water quality detention function; surcharges during storms and drains after storms.  Do not include volume intended for peak flow control.', 1),
(104, 'Wetted Footprint', 'Wetted Footprint', 'Wetted footprint when BMP is half full.', 1),
(105, 'Winter Harvested Water Demand', 'Winter Harvested Water Demand', 'Average daily harvested water demand from November through April. This should be averaged to account for any shutdowns during wet weather and reduction in demand during the winter season.', 1)
