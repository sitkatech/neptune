...
CREATE TABLE [dbo].[BackboneSegment](
	...
	[DownstreamBackboneSegmentID] [varchar](10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [dbo].[BackboneSegment]  WITH CHECK ADD  CONSTRAINT [FK_BackboneSegment_BackboneSegment_DownstreamBackboneSegmentID_BackboneSegmentAlternateID] FOREIGN KEY([DownstreamBackboneSegmentID])
REFERENCES [dbo].[BackboneSegment] ([BackboneSegmentAlternateID])
GO
ALTER TABLE [dbo].[BackboneSegment] CHECK CONSTRAINT [FK_BackboneSegment_BackboneSegment_DownstreamBackboneSegmentID_BackboneSegmentAlternateID]
GO
