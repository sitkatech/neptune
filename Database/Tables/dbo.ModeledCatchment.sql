...
(
 ...
 CONSTRAINT [AK_ModeledCatchment_ModeledCatchmentID_TenantID] UNIQUE NONCLUSTERED 
(
	[ModeledCatchmentID] ASC,
	[TenantID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
...
GO
ALTER TABLE [dbo].[ModeledCatchment]  WITH CHECK ADD  CONSTRAINT [FK_ModeledCatchment_Tenant_TenantID] FOREIGN KEY([TenantID])
REFERENCES [dbo].[Tenant] ([TenantID])
GO
ALTER TABLE [dbo].[ModeledCatchment] CHECK CONSTRAINT [FK_ModeledCatchment_Tenant_TenantID]