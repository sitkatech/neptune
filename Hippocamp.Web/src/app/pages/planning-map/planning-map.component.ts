...
export class PlanningMapComponent implements OnInit {
  ...
  private treatmentBMPOverlayName = "<img src='./assets/main/map-icons/marker-icon-violet.png' style='height:17px; margin-bottom:3px'> Project BMPs";
  ...
  ngOnInit(): void {
    ...
    this.overlayLayers = Object.assign({
      ...
      "<img src='./assets/main/map-legend-images/wqmpBoundary.png' style='height:12px; margin-bottom:4px'> WQMP Boundaries": L.tileLayer.wms(environment.geoserverMapServiceUrl + "/wms?", WQMPsWMSOptions),
