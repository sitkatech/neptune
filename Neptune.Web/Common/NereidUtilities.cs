...
namespace Neptune.Web.Common
{
    public static class NereidUtilities
    {
        ...
        //public static Graph BuildProjectNetworkGraph(NeptuneDbContext dbContext, int projectID, List<int> projectRSBIDs)
        //{
        //    var nodes = new List<Node>();
        //    var edges = new List<Edge>();
        ...
        //public static void MakeDistributedBMPNodesAndEdges(NeptuneDbContext dbContext, out List<Edge> distributedBMPEdges, out List<Node> distributedBMPNodes, int? projectID = null, List<int> projectRegionalSubbasinIDs = null)
        //{
        ...
        //public static void MakeDistributedDelineationNodesAndEdges(NeptuneDbContext dbContext, out List<Edge> delineationEdges, out List<Node> delineationNodes, int? projectID = null, List<int> projectRegionalSubbasinIDs = null)
        //{
        ...
        //private static void MakeWQMPNodesAndEdges(NeptuneDbContext dbContext, out List<Edge> wqmpEdges, out List<Node> wqmpNodes, int? projectID = null, List<int> projectRegionalSubbasinIDs = null)
        //{
        ...
        //public static List<WaterQualityManagementPlanNode> GetWaterQualityManagementPlanNodes(NeptuneDbContext dbContext, int? projectID = null, List<int> projectRegionalSubbasinIDs = null)
        //{
        ...
        //private static void MakeCentralizedBMPNodesAndEdges(NeptuneDbContext dbContext, out List<Edge> centralizedBMPEdges,
        ...
        //public static List<TreatmentBMP> ModelingTreatmentBMPs(NeptuneDbContext dbContext, int? projectID = null, List<int> projectRSBIDs = null)
        //{
        ...
        //    out List<string> missingNodeIDs, out Graph graph, NeptuneDbContext dbContext, HttpClient httpClient, bool isBaselineCondition)
        //{
        //    stackTrace = "";
        ...
        //    out List<string> missingNodeIDs, out Graph graph, NeptuneDbContext dbContext, HttpClient httpClient, bool isBaselineCondition, int projectID, List<int> projectRSBIDs, List<int> projectDistributedDelineationIDs)
        //{
        //    stackTrace = "";
        //    missingNodeIDs = new List<string>();
        ...
        //    dbContext.Database.ExecuteSqlRaw("EXEC dbo.pDeleteProjectNereidResults @projectID", projectIDSqlParam);
        ...
        //    dbContext.Database.ExecuteSqlRaw("EXEC dbo.pProjectGrantScoreUpdate @projectID", projectIDSqlParam);

        //    return nereidResults;
        //}

        //public static IEnumerable<NereidResult> DeltaSolve(out string stackTrace,
        //    out List<string> missingNodeIDs, out Graph graph, NeptuneDbContext dbContext,
        ...
        //private static List<NereidResult> NetworkSolveImpl(List<string> missingNodeIDs, Graph graph, NeptuneDbContext dbContext,
        ...
        //            {
        //                node.PreviousResults = JsonSerializer.Serialize(previousNodeResults);
        ...
        //{
        //    var nereidUrl = NeptuneWebConfiguration.NereidUrl;
        ...
        //    var solveUrl = $"{nereidUrl}/api/v1/watershed/solve?state=ca&region=oc";
        ...
        public static void MarkDownstreamNodeDirty(TreatmentBMP treatmentBMP, NeptuneDbContext dbContext)
        {
            // if this bmp is an upstream, then its downstream node is, obviously...
            if (treatmentBMP.InverseUpstreamBMP.Any())
            {
                MarkTreatmentBMPDirty(treatmentBMP.InverseUpstreamBMP.ToList(), dbContext);
                return;
            }
        ...
        public static void MarkDownstreamNodeDirty(WaterQualityManagementPlan waterQualityManagementPlan, NeptuneDbContext dbContext)
        {
            // otherwise, we're looking for either the Regional Subbasin or the Centralized BMP of the Regional Subbasin
        ...
        private static void MarkRegionalSubbasinDirty(int? regionalSubbasinID, NeptuneDbContext dbContext)
        {
        ...
        private static void MarkTreatmentBMPDirty(vNereidRegionalSubbasinCentralizedBMP treatmentBMP, NeptuneDbContext dbContext)
        {
            var dirtyModelNode = new DirtyModelNode()
            {
                CreateDate = DateTime.Now,
