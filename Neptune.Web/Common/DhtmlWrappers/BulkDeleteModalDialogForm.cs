/*-----------------------------------------------------------------------
<copyright file="BulkDeleteModalDialogForm.cs" company="Sitka Technology Group">
...
namespace Neptune.Web.Common.DhtmlWrappers
{
    public class BulkDeleteModalDialogForm
    {
        ...
        public BulkDeleteModalDialogForm(string dialogUrl, string dialogLinkText, string dialogTitle, string valueColumnName, string returnListName)
        {
            DialogUrl = dialogUrl;
