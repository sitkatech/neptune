...
namespace Neptune.Web.Views.TreatmentBMP
{
    public class ViewTreatmentBMPModelingAttributesViewData : NeptuneViewData
    {
            ...
            Person currentPerson, EFModels.Entities.NeptunePage neptunePage) : base(httpContext, linkGenerator, currentPerson, neptunePage, NeptuneArea.OCStormwaterTools)
        {
            ...
            GridSpec = new ViewTreatmentBMPModelingAttributesGridSpec(linkGenerator, new Dictionary<int, Delineation?>(), new Dictionary<int, string?>(), new Dictionary<int, double>());
