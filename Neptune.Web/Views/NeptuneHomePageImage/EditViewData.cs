...
namespace Neptune.Web.Views.NeptuneHomePageImage
{
    ...
    {
        public readonly EFModels.Entities.NeptuneHomePageImage NeptuneHomePageImage;

        public EditViewData(EFModels.Entities.NeptuneHomePageImage neptuneHomePageImage)
        {
            NeptuneHomePageImage = neptuneHomePageImage;
        }
    }
}
