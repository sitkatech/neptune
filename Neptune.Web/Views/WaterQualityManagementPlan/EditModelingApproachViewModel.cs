/*-----------------------------------------------------------------------
<copyright file="EditModelingApproachViewModel.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
{
    public class EditModelingApproachViewModel : FormViewModel
    {
        [Required]
        ...
        /// </summary>
        public EditModelingApproachViewModel()
        {
        }

        public EditModelingApproachViewModel(EFModels.Entities.WaterQualityManagementPlan waterQualityManagementPlan)
        {
