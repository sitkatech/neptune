...
export class StormwaterJurisdictionService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public jurisdictionsViewableByPersonGet(observe?: 'body', reportProgress?: boolean): Observable<Array<StormwaterJurisdictionDto>>;
    public jurisdictionsViewableByPersonGet(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<StormwaterJurisdictionDto>>>;
    public jurisdictionsViewableByPersonGet(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<StormwaterJurisdictionDto>>>;
    public jurisdictionsViewableByPersonGet(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<StormwaterJurisdictionDto>>(`${this.basePath}/jurisdictions/viewableByPerson`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
