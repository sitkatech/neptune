...
export const DelineationTypesAsSelectDropdownOptions = [{ Value: null, Label: "- Select -", Disabled: true }, ...DelineationTypes.map((x) => ({ Value: x.Value, Label: x.DisplayName } as SelectDropdownOption))];
