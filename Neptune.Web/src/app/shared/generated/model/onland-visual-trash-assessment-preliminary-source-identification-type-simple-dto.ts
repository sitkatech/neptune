...
export class OnlandVisualTrashAssessmentPreliminarySourceIdentificationTypeSimpleDto { 
    OnlandVisualTrashAssessmentPreliminarySourceIdentificationTypeID?: number;
...
export interface OnlandVisualTrashAssessmentPreliminarySourceIdentificationTypeSimpleDtoForm { 
    OnlandVisualTrashAssessmentPreliminarySourceIdentificationTypeID?: FormControl<number>;
...
export class OnlandVisualTrashAssessmentPreliminarySourceIdentificationTypeSimpleDtoFormControls { 
    public static OnlandVisualTrashAssessmentPreliminarySourceIdentificationTypeID = (value: FormControlState<number> | number = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<number>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
