...
export interface FileResourceDtoForm { 
    ...
    CreatePerson?: FormControl<PersonDto>;
...
export class FileResourceDtoFormControls { 
    ...
    public static CreatePerson = (value: FormControlState<PersonDto> | PersonDto = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<PersonDto>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
