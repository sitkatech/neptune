...
export class JurisdictionsLayerComponent {
    ...
    // Constants
    readonly WFS_FEATURE_TYPE = "OCStormwater:Jurisdictions";
    readonly WMS_LAYER_NAME = "OCStormwater:Jurisdictions";
    readonly IDENTIFIER_PROPERTY = "StormwaterJurisdictionID";
    readonly OVERLAY_LABEL = "Jurisdictions";
    readonly WMS_STYLE = "jurisdiction_orange";
