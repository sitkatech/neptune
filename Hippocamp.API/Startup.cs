...
using Hippocamp.API.Services.Telemetry;
...
namespace Hippocamp.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<HippocampConfiguration>(Configuration);
            var hippocampConfiguration = Configuration.Get<HippocampConfiguration>();

            var keystoneHost = hippocampConfiguration.KEYSTONE_HOST;
            ...
            {
                c.UseSqlServer(hippocampConfiguration.DB_CONNECTION_STRING, x =>
                {
            ...
            services.AddSingleton(x => new SitkaSmtpClientService(hippocampConfiguration));
