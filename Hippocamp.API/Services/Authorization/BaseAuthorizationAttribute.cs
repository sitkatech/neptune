...
namespace Hippocamp.API.Services.Authorization
{
    public abstract class BaseAuthorizationAttribute : AuthorizeAttribute, IAuthorizationFilter
    {
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            var dbContextService = context.HttpContext.RequestServices.GetService(typeof(HippocampDbContext));
            if (dbContextService == null || !(dbContextService is HippocampDbContext dbContext))
            {
                //MK 1/16/2018 - If we don't have a repository we are in a terrible state.
                throw new ApplicationException(
                    "Could not find injected HippocampDbRepository. WithRightsAttribute.cs needs your help!");
            }
