...
public class AzureBlobStorageService
{
    ...
    public AzureBlobStorageService(IOptions<HippocampConfiguration> hippocampConfiguration)
    {
        _hippocampConfiguration = hippocampConfiguration.Value;
        _fileResourceContainerClient = new BlobServiceClient(_hippocampConfiguration.BlobStorageConnectionString).GetBlobContainerClient("file-resource");
    }
