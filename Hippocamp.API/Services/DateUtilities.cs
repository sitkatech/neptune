...
namespace Hippocamp.API.Services
{
    public static class DateUtilities
    {
        ...
        /// <summary>
        /// Tests if two given pehippocampds overlap each other.
        /// </summary>
        /// <param name="startDate1">Base pehippocampd start</param>
        /// <param name="endDate1">Base pehippocampd end</param>
        /// <param name="startDate2">Test pehippocampd start</param>
        /// <param name="endDate2">Test pehippocampd end</param>
        /// <returns>
        /// 	<c>true</c> if the pehippocampds overlap; otherwise, <c>false</c>.
        /// </returns>
