...
namespace Neptune.EFModels.Entities
{
    public abstract partial class FieldDefinitionType
    {
        ...
        public static readonly FieldDefinitionTypePassword Password = Neptune.EFModels.Entities.FieldDefinitionTypePassword.Instance;
        public static readonly FieldDefinitionTypeMeasurementUnit MeasurementUnit = Neptune.EFModels.Entities.FieldDefinitionTypeMeasurementUnit.Instance;
        public static readonly FieldDefinitionTypePhotoCaption PhotoCaption = Neptune.EFModels.Entities.FieldDefinitionTypePhotoCaption.Instance;
        public static readonly FieldDefinitionTypePhotoCredit PhotoCredit = Neptune.EFModels.Entities.FieldDefinitionTypePhotoCredit.Instance;
        public static readonly FieldDefinitionTypePhotoTiming PhotoTiming = Neptune.EFModels.Entities.FieldDefinitionTypePhotoTiming.Instance;
        public static readonly FieldDefinitionTypePrimaryContact PrimaryContact = Neptune.EFModels.Entities.FieldDefinitionTypePrimaryContact.Instance;
        public static readonly FieldDefinitionTypeOrganizationType OrganizationType = Neptune.EFModels.Entities.FieldDefinitionTypeOrganizationType.Instance;
        public static readonly FieldDefinitionTypeUsername Username = Neptune.EFModels.Entities.FieldDefinitionTypeUsername.Instance;
        public static readonly FieldDefinitionTypeExternalLinks ExternalLinks = Neptune.EFModels.Entities.FieldDefinitionTypeExternalLinks.Instance;
        public static readonly FieldDefinitionTypeRoleName RoleName = Neptune.EFModels.Entities.FieldDefinitionTypeRoleName.Instance;
        public static readonly FieldDefinitionTypeChartLastUpdatedDate ChartLastUpdatedDate = Neptune.EFModels.Entities.FieldDefinitionTypeChartLastUpdatedDate.Instance;
        public static readonly FieldDefinitionTypeTreatmentBMPType TreatmentBMPType = Neptune.EFModels.Entities.FieldDefinitionTypeTreatmentBMPType.Instance;
        public static readonly FieldDefinitionTypeConveyanceFunctionsAsIntended ConveyanceFunctionsAsIntended = Neptune.EFModels.Entities.FieldDefinitionTypeConveyanceFunctionsAsIntended.Instance;
        public static readonly FieldDefinitionTypeAssessmentScoreWeight AssessmentScoreWeight = Neptune.EFModels.Entities.FieldDefinitionTypeAssessmentScoreWeight.Instance;
        public static readonly FieldDefinitionTypeObservationScore ObservationScore = Neptune.EFModels.Entities.FieldDefinitionTypeObservationScore.Instance;
        public static readonly FieldDefinitionTypeAlternativeScore AlternativeScore = Neptune.EFModels.Entities.FieldDefinitionTypeAlternativeScore.Instance;
        public static readonly FieldDefinitionTypeAssessmentForInternalUseOnly AssessmentForInternalUseOnly = Neptune.EFModels.Entities.FieldDefinitionTypeAssessmentForInternalUseOnly.Instance;
        public static readonly FieldDefinitionTypeTreatmentBMPDesignDepth TreatmentBMPDesignDepth = Neptune.EFModels.Entities.FieldDefinitionTypeTreatmentBMPDesignDepth.Instance;
        public static readonly FieldDefinitionTypeReceivesSystemCommunications ReceivesSystemCommunications = Neptune.EFModels.Entities.FieldDefinitionTypeReceivesSystemCommunications.Instance;
        public static readonly FieldDefinitionTypeJurisdiction Jurisdiction = Neptune.EFModels.Entities.FieldDefinitionTypeJurisdiction.Instance;
        public static readonly FieldDefinitionTypeDelineation Delineation = Neptune.EFModels.Entities.FieldDefinitionTypeDelineation.Instance;
        public static readonly FieldDefinitionTypeTreatmentBMP TreatmentBMP = Neptune.EFModels.Entities.FieldDefinitionTypeTreatmentBMP.Instance;
        public static readonly FieldDefinitionTypeTreatmentBMPAssessmentObservationType TreatmentBMPAssessmentObservationType = Neptune.EFModels.Entities.FieldDefinitionTypeTreatmentBMPAssessmentObservationType.Instance;
        public static readonly FieldDefinitionTypeObservationCollectionMethod ObservationCollectionMethod = Neptune.EFModels.Entities.FieldDefinitionTypeObservationCollectionMethod.Instance;
        public static readonly FieldDefinitionTypeObservationThresholdType ObservationThresholdType = Neptune.EFModels.Entities.FieldDefinitionTypeObservationThresholdType.Instance;
        public static readonly FieldDefinitionTypeObservationTargetType ObservationTargetType = Neptune.EFModels.Entities.FieldDefinitionTypeObservationTargetType.Instance;
        public static readonly FieldDefinitionTypeMeasurementUnitLabel MeasurementUnitLabel = Neptune.EFModels.Entities.FieldDefinitionTypeMeasurementUnitLabel.Instance;
        public static readonly FieldDefinitionTypePropertiesToObserve PropertiesToObserve = Neptune.EFModels.Entities.FieldDefinitionTypePropertiesToObserve.Instance;
        public static readonly FieldDefinitionTypeMinimumNumberOfObservations MinimumNumberOfObservations = Neptune.EFModels.Entities.FieldDefinitionTypeMinimumNumberOfObservations.Instance;
        public static readonly FieldDefinitionTypeMaximumNumberOfObservations MaximumNumberOfObservations = Neptune.EFModels.Entities.FieldDefinitionTypeMaximumNumberOfObservations.Instance;
        public static readonly FieldDefinitionTypeMinimumValueOfEachObservation MinimumValueOfEachObservation = Neptune.EFModels.Entities.FieldDefinitionTypeMinimumValueOfEachObservation.Instance;
        public static readonly FieldDefinitionTypeMaximumValueOfEachObservation MaximumValueOfEachObservation = Neptune.EFModels.Entities.FieldDefinitionTypeMaximumValueOfEachObservation.Instance;
        public static readonly FieldDefinitionTypeDefaultThresholdValue DefaultThresholdValue = Neptune.EFModels.Entities.FieldDefinitionTypeDefaultThresholdValue.Instance;
        public static readonly FieldDefinitionTypeDefaultBenchmarkValue DefaultBenchmarkValue = Neptune.EFModels.Entities.FieldDefinitionTypeDefaultBenchmarkValue.Instance;
        public static readonly FieldDefinitionTypeAssessmentFailsIfObservationFails AssessmentFailsIfObservationFails = Neptune.EFModels.Entities.FieldDefinitionTypeAssessmentFailsIfObservationFails.Instance;
        public static readonly FieldDefinitionTypeCustomAttributeType CustomAttributeType = Neptune.EFModels.Entities.FieldDefinitionTypeCustomAttributeType.Instance;
        public static readonly FieldDefinitionTypeCustomAttributeDataType CustomAttributeDataType = Neptune.EFModels.Entities.FieldDefinitionTypeCustomAttributeDataType.Instance;
        public static readonly FieldDefinitionTypeMaintenanceRecordType MaintenanceRecordType = Neptune.EFModels.Entities.FieldDefinitionTypeMaintenanceRecordType.Instance;
        public static readonly FieldDefinitionTypeMaintenanceRecord MaintenanceRecord = Neptune.EFModels.Entities.FieldDefinitionTypeMaintenanceRecord.Instance;
        public static readonly FieldDefinitionTypeAttributeTypePurpose AttributeTypePurpose = Neptune.EFModels.Entities.FieldDefinitionTypeAttributeTypePurpose.Instance;
        public static readonly FieldDefinitionTypeFundingSource FundingSource = Neptune.EFModels.Entities.FieldDefinitionTypeFundingSource.Instance;
        public static readonly FieldDefinitionTypeIsPostMaintenanceAssessment IsPostMaintenanceAssessment = Neptune.EFModels.Entities.FieldDefinitionTypeIsPostMaintenanceAssessment.Instance;
        public static readonly FieldDefinitionTypeFundingEvent FundingEvent = Neptune.EFModels.Entities.FieldDefinitionTypeFundingEvent.Instance;
        public static readonly FieldDefinitionTypeFieldVisit FieldVisit = Neptune.EFModels.Entities.FieldDefinitionTypeFieldVisit.Instance;
        public static readonly FieldDefinitionTypeFieldVisitStatus FieldVisitStatus = Neptune.EFModels.Entities.FieldDefinitionTypeFieldVisitStatus.Instance;
        public static readonly FieldDefinitionTypeWaterQualityManagementPlan WaterQualityManagementPlan = Neptune.EFModels.Entities.FieldDefinitionTypeWaterQualityManagementPlan.Instance;
        public static readonly FieldDefinitionTypeParcel Parcel = Neptune.EFModels.Entities.FieldDefinitionTypeParcel.Instance;
        public static readonly FieldDefinitionTypeRequiredLifespanOfInstallation RequiredLifespanOfInstallation = Neptune.EFModels.Entities.FieldDefinitionTypeRequiredLifespanOfInstallation.Instance;
        public static readonly FieldDefinitionTypeRequiredFieldVisitsPerYear RequiredFieldVisitsPerYear = Neptune.EFModels.Entities.FieldDefinitionTypeRequiredFieldVisitsPerYear.Instance;
        public static readonly FieldDefinitionTypeRequiredPostStormFieldVisitsPerYear RequiredPostStormFieldVisitsPerYear = Neptune.EFModels.Entities.FieldDefinitionTypeRequiredPostStormFieldVisitsPerYear.Instance;
        public static readonly FieldDefinitionTypeWaterQualityManagementPlanDocumentType WaterQualityManagementPlanDocumentType = Neptune.EFModels.Entities.FieldDefinitionTypeWaterQualityManagementPlanDocumentType.Instance;
        public static readonly FieldDefinitionTypeHasAllRequiredDocuments HasAllRequiredDocuments = Neptune.EFModels.Entities.FieldDefinitionTypeHasAllRequiredDocuments.Instance;
        public static readonly FieldDefinitionTypeDateOfLastInventoryChange DateOfLastInventoryChange = Neptune.EFModels.Entities.FieldDefinitionTypeDateOfLastInventoryChange.Instance;
        public static readonly FieldDefinitionTypeTrashCaptureStatus TrashCaptureStatus = Neptune.EFModels.Entities.FieldDefinitionTypeTrashCaptureStatus.Instance;
        public static readonly FieldDefinitionTypeOnlandVisualTrashAssessment OnlandVisualTrashAssessment = Neptune.EFModels.Entities.FieldDefinitionTypeOnlandVisualTrashAssessment.Instance;
        public static readonly FieldDefinitionTypeOnlandVisualTrashAssessmentNotes OnlandVisualTrashAssessmentNotes = Neptune.EFModels.Entities.FieldDefinitionTypeOnlandVisualTrashAssessmentNotes.Instance;
        public static readonly FieldDefinitionTypeDelineationType DelineationType = Neptune.EFModels.Entities.FieldDefinitionTypeDelineationType.Instance;
        public static readonly FieldDefinitionTypeBaselineScore BaselineScore = Neptune.EFModels.Entities.FieldDefinitionTypeBaselineScore.Instance;
        public static readonly FieldDefinitionTypeSizingBasis SizingBasis = Neptune.EFModels.Entities.FieldDefinitionTypeSizingBasis.Instance;
        public static readonly FieldDefinitionTypeProgressScore ProgressScore = Neptune.EFModels.Entities.FieldDefinitionTypeProgressScore.Instance;
        public static readonly FieldDefinitionTypeAssessmentScore AssessmentScore = Neptune.EFModels.Entities.FieldDefinitionTypeAssessmentScore.Instance;
        public static readonly FieldDefinitionTypeViaFullCapture ViaFullCapture = Neptune.EFModels.Entities.FieldDefinitionTypeViaFullCapture.Instance;
        public static readonly FieldDefinitionTypeViaPartialCapture ViaPartialCapture = Neptune.EFModels.Entities.FieldDefinitionTypeViaPartialCapture.Instance;
        public static readonly FieldDefinitionTypeViaOVTAScore ViaOVTAScore = Neptune.EFModels.Entities.FieldDefinitionTypeViaOVTAScore.Instance;
        public static readonly FieldDefinitionTypeTotalAchieved TotalAchieved = Neptune.EFModels.Entities.FieldDefinitionTypeTotalAchieved.Instance;
        public static readonly FieldDefinitionTypeTargetLoadReduction TargetLoadReduction = Neptune.EFModels.Entities.FieldDefinitionTypeTargetLoadReduction.Instance;
        public static readonly FieldDefinitionTypeLoadingRate LoadingRate = Neptune.EFModels.Entities.FieldDefinitionTypeLoadingRate.Instance;
        public static readonly FieldDefinitionTypeLandUse LandUse = Neptune.EFModels.Entities.FieldDefinitionTypeLandUse.Instance;
        public static readonly FieldDefinitionTypeArea Area = Neptune.EFModels.Entities.FieldDefinitionTypeArea.Instance;
        public static readonly FieldDefinitionTypeImperviousArea ImperviousArea = Neptune.EFModels.Entities.FieldDefinitionTypeImperviousArea.Instance;
        public static readonly FieldDefinitionTypeGrossArea GrossArea = Neptune.EFModels.Entities.FieldDefinitionTypeGrossArea.Instance;
        public static readonly FieldDefinitionTypeLandUseStatistics LandUseStatistics = Neptune.EFModels.Entities.FieldDefinitionTypeLandUseStatistics.Instance;
        public static readonly FieldDefinitionTypeRegionalSubbasin RegionalSubbasin = Neptune.EFModels.Entities.FieldDefinitionTypeRegionalSubbasin.Instance;
        public static readonly FieldDefinitionTypeAverageDivertedFlowrate AverageDivertedFlowrate = Neptune.EFModels.Entities.FieldDefinitionTypeAverageDivertedFlowrate.Instance;
        public static readonly FieldDefinitionTypeAverageTreatmentFlowrate AverageTreatmentFlowrate = Neptune.EFModels.Entities.FieldDefinitionTypeAverageTreatmentFlowrate.Instance;
        public static readonly FieldDefinitionTypeDesignDryWeatherTreatmentCapacity DesignDryWeatherTreatmentCapacity = Neptune.EFModels.Entities.FieldDefinitionTypeDesignDryWeatherTreatmentCapacity.Instance;
        public static readonly FieldDefinitionTypeDesignLowFlowDiversionCapacity DesignLowFlowDiversionCapacity = Neptune.EFModels.Entities.FieldDefinitionTypeDesignLowFlowDiversionCapacity.Instance;
        public static readonly FieldDefinitionTypeDesignMediaFiltrationRate DesignMediaFiltrationRate = Neptune.EFModels.Entities.FieldDefinitionTypeDesignMediaFiltrationRate.Instance;
        public static readonly FieldDefinitionTypeDesignResidenceTimeForPermanentPool DesignResidenceTimeForPermanentPool = Neptune.EFModels.Entities.FieldDefinitionTypeDesignResidenceTimeForPermanentPool.Instance;
        public static readonly FieldDefinitionTypeDiversionRate DiversionRate = Neptune.EFModels.Entities.FieldDefinitionTypeDiversionRate.Instance;
        public static readonly FieldDefinitionTypeDrawdownTimeForWQDetentionVolume DrawdownTimeForWQDetentionVolume = Neptune.EFModels.Entities.FieldDefinitionTypeDrawdownTimeForWQDetentionVolume.Instance;
        public static readonly FieldDefinitionTypeEffectiveFootprint EffectiveFootprint = Neptune.EFModels.Entities.FieldDefinitionTypeEffectiveFootprint.Instance;
        public static readonly FieldDefinitionTypeEffectiveRetentionDepth EffectiveRetentionDepth = Neptune.EFModels.Entities.FieldDefinitionTypeEffectiveRetentionDepth.Instance;
        ...
        public static readonly FieldDefinitionTypeWettedFootprint WettedFootprint = Neptune.EFModels.Entities.FieldDefinitionTypeWettedFootprint.Instance;
        public static readonly FieldDefinitionTypeWinterHarvestedWaterDemand WinterHarvestedWaterDemand = Neptune.EFModels.Entities.FieldDefinitionTypeWinterHarvestedWaterDemand.Instance;
        public static readonly FieldDefinitionTypePercentOfSiteTreated PercentOfSiteTreated = Neptune.EFModels.Entities.FieldDefinitionTypePercentOfSiteTreated.Instance;
        public static readonly FieldDefinitionTypePercentCaptured PercentCaptured = Neptune.EFModels.Entities.FieldDefinitionTypePercentCaptured.Instance;
        public static readonly FieldDefinitionTypePercentRetained PercentRetained = Neptune.EFModels.Entities.FieldDefinitionTypePercentRetained.Instance;
        public static readonly FieldDefinitionTypeAreaWithinWQMP AreaWithinWQMP = Neptune.EFModels.Entities.FieldDefinitionTypeAreaWithinWQMP.Instance;
        public static readonly FieldDefinitionTypeWatershed Watershed = Neptune.EFModels.Entities.FieldDefinitionTypeWatershed.Instance;
        public static readonly FieldDefinitionTypeDesignStormwaterDepth DesignStormwaterDepth = Neptune.EFModels.Entities.FieldDefinitionTypeDesignStormwaterDepth.Instance;
        ...
        public static readonly FieldDefinitionTypeTPIScore TPIScore = Neptune.EFModels.Entities.FieldDefinitionTypeTPIScore.Instance;
        public static readonly FieldDefinitionTypeWQLRI WQLRI = Neptune.EFModels.Entities.FieldDefinitionTypeWQLRI.Instance;
        public static readonly FieldDefinitionTypePollutantContributiontoSEA PollutantContributiontoSEA = Neptune.EFModels.Entities.FieldDefinitionTypePollutantContributiontoSEA.Instance;
        public static readonly FieldDefinitionTypeSiteRunoff SiteRunoff = Neptune.EFModels.Entities.FieldDefinitionTypeSiteRunoff.Instance;
        public static readonly FieldDefinitionTypeTreatedAndDischarged TreatedAndDischarged = Neptune.EFModels.Entities.FieldDefinitionTypeTreatedAndDischarged.Instance;
        public static readonly FieldDefinitionTypeRetainedOrRecycled RetainedOrRecycled = Neptune.EFModels.Entities.FieldDefinitionTypeRetainedOrRecycled.Instance;
        public static readonly FieldDefinitionTypeUntreatedBypassOrOverflow UntreatedBypassOrOverflow = Neptune.EFModels.Entities.FieldDefinitionTypeUntreatedBypassOrOverflow.Instance;
        public static readonly FieldDefinitionTypeTotalSuspendedSolids TotalSuspendedSolids = Neptune.EFModels.Entities.FieldDefinitionTypeTotalSuspendedSolids.Instance;
        public static readonly FieldDefinitionTypeTotalNitrogen TotalNitrogen = Neptune.EFModels.Entities.FieldDefinitionTypeTotalNitrogen.Instance;
        public static readonly FieldDefinitionTypeTotalPhosphorous TotalPhosphorous = Neptune.EFModels.Entities.FieldDefinitionTypeTotalPhosphorous.Instance;
        public static readonly FieldDefinitionTypeFecalColiform FecalColiform = Neptune.EFModels.Entities.FieldDefinitionTypeFecalColiform.Instance;
        public static readonly FieldDefinitionTypeTotalCopper TotalCopper = Neptune.EFModels.Entities.FieldDefinitionTypeTotalCopper.Instance;
        public static readonly FieldDefinitionTypeTotalLead TotalLead = Neptune.EFModels.Entities.FieldDefinitionTypeTotalLead.Instance;
        public static readonly FieldDefinitionTypeTotalZinc TotalZinc = Neptune.EFModels.Entities.FieldDefinitionTypeTotalZinc.Instance;
        public static readonly FieldDefinitionTypeOCTAWatershed OCTAWatershed = Neptune.EFModels.Entities.FieldDefinitionTypeOCTAWatershed.Instance;
        public static readonly FieldDefinitionTypeEffectiveAreaAcres EffectiveAreaAcres = Neptune.EFModels.Entities.FieldDefinitionTypeEffectiveAreaAcres.Instance;
        public static readonly FieldDefinitionTypeDesignStormDepth85thPercentile DesignStormDepth85thPercentile = Neptune.EFModels.Entities.FieldDefinitionTypeDesignStormDepth85thPercentile.Instance;
        public static readonly FieldDefinitionTypeDesignVolume85thPercentile DesignVolume85thPercentile = Neptune.EFModels.Entities.FieldDefinitionTypeDesignVolume85thPercentile.Instance;
        public static readonly FieldDefinitionTypeLandUseBasedWaterQualityScore LandUseBasedWaterQualityScore = Neptune.EFModels.Entities.FieldDefinitionTypeLandUseBasedWaterQualityScore.Instance;
        public static readonly FieldDefinitionTypeReceivingWaterScore ReceivingWaterScore = Neptune.EFModels.Entities.FieldDefinitionTypeReceivingWaterScore.Instance;
