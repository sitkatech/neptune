...
('Dry Weather Flow Override',5, null, 1, 'Indicates if the modeled values for Dry Weather Flow have been overridden', 1, '["No - As Modeled", "Yes - DWF Effectively Eliminated"]'),
...
('Routing Configuration', 5, null, 1, 'This specifies whether the BMP receives all flow from the drainage area (online), or if there is a diversion structure that limits the flow into the BMP (offline).', 1,'["Offline", "Online"]'),
...
('Time Of Concentration',5,17, 1, 'The time required for the entire drainage to begin contributing runoff to the BMP. This value must be less than 60 minutes. See TGD guidance.', 1, '[ "5", "10", "15", "20", "30", "45", "60"]'),
...
('Underlying Hydrologic Soil Group',5, null, 1, 'Choose the soil group that best represents the soils underlying the BMP. This is used to estimate a default infiltration rate (A = XX, B = XX, C=XX, D=XX)', 1,'["A", "B", "C", "D", "Liner"]'),
