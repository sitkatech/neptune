CREATE TABLE [dbo].[WaterQualityManagementPlanVisitStatus](
	...
	[WaterQualityManagementPlanVisitStatusDisplayName] [varchar](100) CONSTRAINT [AK_WaterQualityManagementPlanVisitStatus_WaterQualityManagementPlanVisitStatusDisplayName] UNIQUE
)
