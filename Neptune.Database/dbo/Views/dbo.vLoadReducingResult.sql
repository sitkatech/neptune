create view dbo.vLoadReducingResult
as
...
select  NereidResultID, 
        ...
        where nr.TreatmentBMPID is not null or nr.WaterQualityManagementPlanID is not null
GO
/*
select * from dbo.vLoadReducingResult where TreatmentBMPID = 35
*/