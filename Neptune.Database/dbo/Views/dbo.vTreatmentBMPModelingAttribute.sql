...
select tbmp.TreatmentBMPID, UpstreamBMPID,
	...
	cast(max(case when cat.CustomAttributeTypeName = 'Extended Detention Surcharge Volume' then cav.AttributeValue else null end) as float) as ExtendedDetentionSurchargeVolume,
