Create View dbo.vTreatmentBMPGdbExport
as
...
select	tb.TreatmentBMPID, tb.TreatmentBMPName, tbt.TreatmentBMPTypeID, tbt.TreatmentBMPTypeName, sj.StormwaterJurisdictionID, o.OrganizationName
		...
		, tb.OwnerOrganizationID, oo.OrganizationName as OwnerOrganizationName, tb.SystemOfRecordID, tb.LocationPoint
