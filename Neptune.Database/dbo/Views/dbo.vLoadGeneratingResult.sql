create view dbo.vLoadGeneratingResult
as

select  NereidResultID,
        IsBaselineCondition,
        nr.WaterQualityManagementPlanID,
        nr.RegionalSubbasinID,
        nr.DelineationID,
        NodeID,
--        FullResponse,
        LastUpdate,
...
GO
/*
select * from dbo.vLoadGeneratingResult where ProjectID = 14
*/