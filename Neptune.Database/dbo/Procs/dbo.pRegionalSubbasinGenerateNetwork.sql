...
As
    declare @regionalSubbasinID int 
    set @regionalSubbasinID = (select top 1 RegionalSubbasinID from dbo.RegionalSubbasin where CatchmentGeometry4326.STContains(geometry::Point(@longitude, @latitude, 4326)) = 1)
