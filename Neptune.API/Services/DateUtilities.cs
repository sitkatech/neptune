...
namespace Neptune.API.Services
{
    public static class DateUtilities
    {
        ...
        /// <summary>
        /// Tests if two given peneptuneds overlap each other.
        /// </summary>
        /// <param name="startDate1">Base peneptuned start</param>
        /// <param name="endDate1">Base peneptuned end</param>
        /// <param name="startDate2">Test peneptuned start</param>
        /// <param name="endDate2">Test peneptuned end</param>
        /// <returns>
        /// 	<c>true</c> if the peneptuneds overlap; otherwise, <c>false</c>.
        /// </returns>
