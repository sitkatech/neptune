...
public class BlobFileTransferJob : ScheduledBackgroundJobBase<BlobFileTransferJob>
{
    ...
    public BlobFileTransferJob(
        ...
        SitkaSmtpClientService sitkaSmtpClient, AzureBlobStorageService blobStorageService) : base(JobName, logger, webHostEnvironment, dbContext, neptuneConfiguration, sitkaSmtpClient)
    {
    ...
    protected override async void RunJobImplementation()
    {
        ...
        foreach (var fileResource in nextFileResourcesToMove)
        {
            ...
            var created = await _blobStorageService.UploadFileResource(fileResource, bytes);
