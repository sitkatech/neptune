...
namespace JetBrains.Annotations
{
  ...
  internal sealed class LocalizationRequiredAttribute : Attribute
  {
    ...
    /// </summary>
    [UsedImplicitly] internal bool Required { get; private set; }
  ...
  internal sealed class StringFormatMethodAttribute : Attribute
  {
    ...
    /// </summary>
    [UsedImplicitly] internal string FormatParameterName { get; private set; }
  }
  ...
  internal sealed class NotifyPropertyChangedInvocatorAttribute : Attribute
  {
    ...
    [UsedImplicitly] internal string ParameterName { get; private set; }
  }
  ...
  {
    internal ContractAnnotationAttribute([NotNull] string fdt) : this (fdt, false)
    {
    }
  ...
  {
    [UsedImplicitly] internal UsedImplicitlyAttribute()
    ...
    [UsedImplicitly] internal UsedImplicitlyAttribute(ImplicitUseKindFlags useKindFlags)
      : this(useKindFlags, ImplicitUseTargetFlags.Default) { }

    [UsedImplicitly] internal UsedImplicitlyAttribute(ImplicitUseTargetFlags targetFlags)
  ...
  {
    [UsedImplicitly] internal MeansImplicitUseAttribute() 
      : this(ImplicitUseKindFlags.Default, ImplicitUseTargetFlags.Default) { }
    ...
    [UsedImplicitly] internal MeansImplicitUseAttribute(ImplicitUseKindFlags useKindFlags)
      : this(useKindFlags, ImplicitUseTargetFlags.Default)
    {
    }

    [UsedImplicitly] internal MeansImplicitUseAttribute(ImplicitUseTargetFlags targetFlags)
      : this(ImplicitUseKindFlags.Default, targetFlags) { }
  ...
  internal class PathReferenceAttribute : Attribute
  {
    ...
    [UsedImplicitly] internal string BasePath { get; private set; }
  }
  ...
  {
    [UsedImplicitly] internal string AnonymousProperty { get; private set; }
  ...
  internal sealed class AspMvcAreaAttribute : PathReferenceAttribute
  {
    ...
    [UsedImplicitly] internal AspMvcAreaAttribute() { }
  ...
  /// <summary>
  /// ASP.NET MVC attribute. Indicates that a parameter is an MVC viewModel type.
  /// Use this attribute for custom wrappers similar to 
