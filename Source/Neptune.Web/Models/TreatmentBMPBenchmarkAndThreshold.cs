        ...
        public string GetAuditDescriptionString()
        {
            var treatmentBMPAssessmentObservationType =
                HttpRequestStorage.DatabaseEntities.TreatmentBMPAssessmentObservationTypes
                    .GetTreatmentBMPAssessmentObservationType(TreatmentBMPAssessmentObservationTypeID);
            var treatmentBMP = HttpRequestStorage.DatabaseEntities.TreatmentBMPs.GetTreatmentBMP(TreatmentBMPID);

            return
                $"Treatment BMP: {treatmentBMP.TreatmentBMPName}, Observation Type: {treatmentBMPAssessmentObservationType.TreatmentBMPAssessmentObservationTypeName}, Benchmark Value: {BenchmarkValue}, Threshold Value: {ThresholdValue}";
        }
    }
}