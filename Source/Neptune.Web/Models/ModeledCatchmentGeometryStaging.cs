...
{
    public partial class ModeledCatchmentGeometryStaging : IAuditableEntity
    {
        public static List<ModeledCatchmentGeometryStaging> CreateModeledCatchmentGeometryStagingListFromGdb(FileInfo gdbFile, Person currentPerson)
        {
        ...
        public string GetAuditDescriptionString() => $"Modeled catchment geometry staging {ModeledCatchmentGeometryStagingID}";
