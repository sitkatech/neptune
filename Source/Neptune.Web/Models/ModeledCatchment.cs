/*-----------------------------------------------------------------------
<copyright file="ModeledCatchment.cs" company="Tahoe Regional Planning Agency">
...
namespace Neptune.Web.Models
{
    public partial class ModeledCatchment : IAuditableEntity
    {
        ...
        {
            return currentPerson.IsAssignedToStormwaterJurisdiction(StormwaterJurisdiction);
        }
