...
namespace Neptune.Web.Models
{
    ...
    public partial class TreatmentBMP : IHavePrimaryKey, IHaveATenantID
    {
        ...
        /// </summary>
        public TreatmentBMP(int treatmentBMPID, string treatmentBMPName, int treatmentBMPTypeID, DbGeometry locationPoint, int stormwaterJurisdictionID, int? modeledCatchmentID, string notes, string systemOfRecordID, int? yearBuilt, int ownerOrganizationID, int? waterQualityManagementPlanID, int? treatmentBMPLifespanTypeID, DateTime? treatmentBMPLifespanEndDate, int? requiredFieldVisitsPerYear, int? requiredPostStormFieldVisitsPerYear, bool inventoryIsVerified, DateTime? inventoryIsVerifiedDate) : this()
        {
            ...
            this.InventoryIsVerifiedDate = inventoryIsVerifiedDate;
        }
        ...
        public DateTime? InventoryIsVerifiedDate { get; set; }
        [NotMapped]
