...
namespace Neptune.Web.Models
{
    ...
    public partial class Parcel : IHavePrimaryKey, ICanDeleteFull
    {
        ...
        /// </summary>
        public Parcel(int parcelID, string parcelNumber, string ownerName, string parcelStreetNumber, string parcelAddress, string parcelZipCode, string landUse, int? squareFeetHome, int? squareFeetLot, double parcelAreaInAcres) : this()
        {
        ...
        /// </summary>
        public Parcel(string parcelNumber, double parcelAreaInAcres) : this()
        {
        ...
        {
            return new Parcel(default(string), default(double));
        }
        ...
        {
            return (ParcelGeometry != null) || WaterQualityManagementPlanParcels.Any();
        }
        ...
        public List<string> DependentObjectNames() 
        {
            ...
            {
                dependentObjects.Add(typeof(ParcelGeometry).Name);
            }
        ...
        /// </summary>
        public static readonly List<string> DependentEntityTypeNames = new List<string> {typeof(Parcel).Name, typeof(ParcelGeometry).Name, typeof(WaterQualityManagementPlanParcel).Name};
        ...
        public void DeleteChildren(DatabaseEntities dbContext)
        {
            ...
            foreach(var x in ParcelGeometries.ToList())
            {
        ...
        [NotMapped]
        public ParcelGeometry ParcelGeometry { get { return ParcelGeometries.SingleOrDefault(); } set { ParcelGeometries = new List<ParcelGeometry>{value};} }
