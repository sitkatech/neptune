...
{
    // Table [dbo].[AuditLog] is NOT multi-tenant, so is attributed as ICanDeleteFull
    [Table("[dbo].[AuditLog]")]
    public partial class AuditLog : IHavePrimaryKey, ICanDeleteFull
    {
        ...
        /// </summary>
        public AuditLog(int auditLogID, int personID, DateTime auditLogDate, int auditLogEventTypeID, string tableName, int recordID, string columnName, string originalValue, string newValue, string auditDescription) : this()
        {
