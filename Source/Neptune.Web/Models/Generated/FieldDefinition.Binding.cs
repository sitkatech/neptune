...
namespace Neptune.Web.Models
{
    public abstract partial class FieldDefinition : IHavePrimaryKey
    {
        ...
        public static readonly FieldDefinitionMonthsOperational MonthsOperational = FieldDefinitionMonthsOperational.Instance;
        ...
        public static readonly FieldDefinitionModeledPerformance ModeledPerformance = FieldDefinitionModeledPerformance.Instance;
        ...
        public static FieldDefinition ToType(FieldDefinitionEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                case FieldDefinitionEnum.Delineation:
                    return Delineation;
                case FieldDefinitionEnum.DelineationStatus:
                ...
                case FieldDefinitionEnum.DesignStormwaterDepth:
                ...
                case FieldDefinitionEnum.HydromodificationApplies:
                ...
                case FieldDefinitionEnum.ModeledPerformance:
                    return ModeledPerformance;
                case FieldDefinitionEnum.MonthsOperational:
    ...
    public partial class FieldDefinitionPercentOfSiteTreated : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionPercentOfSiteTreated Instance = new FieldDefinitionPercentOfSiteTreated(106, @"PercentOfSiteTreated", @"% of Site Treated", @"", true);
    }
    ...
    public partial class FieldDefinitionWatershed : FieldDefinition
    {
        ...
        public static readonly FieldDefinitionWatershed Instance = new FieldDefinitionWatershed(110, @"Watershed", @"Watershed", @"", true);
    }

    public partial class FieldDefinitionDesignStormwaterDepth : FieldDefinition
    {
    ...
    public partial class FieldDefinitionHydromodificationApplies : FieldDefinition
    {
        private FieldDefinitionHydromodificationApplies(int fieldDefinitionID, string fieldDefinitionName, string fieldDefinitionDisplayName, string defaultDefinition, bool canCustomizeLabel) : base(fieldDefinitionID, fieldDefinitionName, fieldDefinitionDisplayName, defaultDefinition, canCustomizeLabel) {}
        public static readonly FieldDefinitionHydromodificationApplies Instance = new FieldDefinitionHydromodificationApplies(113, @"HydromodificationApplies", @"Hydromodification Controls Apply", @"", true);
    }

    public partial class FieldDefinitionDelineationStatus : FieldDefinition
    {
    ...
    public partial class FieldDefinitionModeledPerformance : FieldDefinition
    {
        private FieldDefinitionModeledPerformance(int fieldDefinitionID, string fieldDefinitionName, string fieldDefinitionDisplayName, string defaultDefinition, bool canCustomizeLabel) : base(fieldDefinitionID, fieldDefinitionName, fieldDefinitionDisplayName, defaultDefinition, canCustomizeLabel) {}
        public static readonly FieldDefinitionModeledPerformance Instance = new FieldDefinitionModeledPerformance(116, @"ModeledPerformance", @"Modeled Performance", @"If the Detailed modeling approach is used, then this table represents the portion of the site that drains to inventoried BMPs; If the Simplified modeling approach is used, then this table represents the inventoried parcel(s)", true);
    }
}