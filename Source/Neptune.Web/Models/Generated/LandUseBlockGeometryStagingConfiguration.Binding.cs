...
namespace Neptune.Web.Models
{
    public class LandUseBlockGeometryStagingConfiguration : EntityTypeConfiguration<LandUseBlockGeometryStaging>
    {
        ...
        public LandUseBlockGeometryStagingConfiguration(string schema)
        {
            ...
            HasRequired(a => a.StormwaterJurisdiction).WithMany(b => b.LandUseBlockGeometryStagings).HasForeignKey(c => c.StormwaterJurisdictionID).WillCascadeOnDelete(false); // FK_LandUseBlockGeometryStaging_StormwaterJurisdiction_StormwaterJurisdictionID
        }
    }
}