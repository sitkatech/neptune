...
namespace Neptune.Web.Models
{
    ...
    public partial class OnlandVisualTrashAssessmentArea : IHavePrimaryKey, ICanDeleteFull
    {
        ...
        /// </summary>
        public OnlandVisualTrashAssessmentArea(int onlandVisualTrashAssessmentAreaID, DbGeometry onlandVisualTrashAssessmentAreaGeometry) : this()
        {
        ...
        /// </summary>
        public OnlandVisualTrashAssessmentArea(DbGeometry onlandVisualTrashAssessmentAreaGeometry) : this()
        {
        ...
        /// </summary>
        public static OnlandVisualTrashAssessmentArea CreateNewBlank()
        {
            return new OnlandVisualTrashAssessmentArea(default(DbGeometry));
        }
