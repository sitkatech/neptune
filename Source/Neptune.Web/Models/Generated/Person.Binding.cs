...
namespace Neptune.Web.Models
{
    ...
    public partial class Person : IHavePrimaryKey, ICanDeleteFull
    {
        ...
        protected Person()
        {
            ...
            this.LandUseBlockGeomteryStagings = new HashSet<LandUseBlockGeomteryStaging>();
        ...
        public void DeleteChildren(DatabaseEntities dbContext)
        {
            ...
            foreach(var x in LandUseBlockGeomteryStagings.ToList())
            {
                x.DeleteFull(dbContext);
            }
        ...
        public virtual ICollection<LandUseBlockGeomteryStaging> LandUseBlockGeomteryStagings { get; set; }
