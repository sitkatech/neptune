...
namespace Neptune.Web.Models
{
    public class TrashGeneratingUnitConfiguration : EntityTypeConfiguration<TrashGeneratingUnit>
    {
        ...
        public TrashGeneratingUnitConfiguration(string schema)
        {
            ...
            Property(x => x.TrashGeneratingUnitGeometry4326).HasColumnName(@"TrashGeneratingUnitGeometry4326").HasColumnType("geometry").IsOptional();
            ...
            HasOptional(a => a.Delineation).WithMany(b => b.TrashGeneratingUnits).HasForeignKey(c => c.DelineationID).WillCascadeOnDelete(false); // FK_TrashGeneratingUnit_Delineation_DelineationID
        }
    }
}