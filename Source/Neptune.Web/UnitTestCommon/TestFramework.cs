...
namespace Neptune.Web.UnitTestCommon
{
    public static partial class TestFramework
    {
        ...
        {
            Assert.That(validationResults.Any(x => x.ErrorMessage.Contains(String.Format("The {0} field is required", propertyName))), Is.True, "Should have error message");
        }
        ...
        {
            Assert.That(validationResults.Any(x => x.ErrorMessage.Contains(String.Format("The field {0} must be a string with a maximum length of {1}.", propertyName, maxLength))),
                Is.True,
        ...
        {
            Assert.That(validationResults.Any(x => x.ErrorMessage.Contains(NeptuneValidationMessages.LettersNumbersSpacesDashesAndUnderscoresOnly)),
                Is.True,
                "Should have error message");
        }
        ...
        {
            Assert.That(validationResults.Any(x => x.ErrorMessage.Contains(NeptuneValidationMessages.LettersOnly)),
                Is.True,
                "Should have error message");
        }
    }
