/*-----------------------------------------------------------------------
<copyright file="NeptuneBaseControllerTest.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
{
    [TestFixture]
    public class NeptuneBaseControllerTest
    {
        [Test]
        ...
        {
            var methods = NeptuneBaseController.AllControllerActionMethods;
            var missing =
                methods.Where(
                    x =>
                        x.GetParameters()
