/*-----------------------------------------------------------------------
<copyright file="NeptunePageManageFeature.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
namespace Neptune.Web.Security
{
    ...
    public class NeptunePageManageFeature : NeptuneFeatureWithContext, INeptuneBaseFeatureWithContext<NeptunePage>
    {
        ...
        public void DemandPermission(Person person, NeptunePage contextModelObject)
        {
            _neptuneFeatureWithContextImpl.DemandPermission(person, contextModelObject);
        }

        public PermissionCheckResult HasPermission(Person person, NeptunePage contextModelObject)
        {
