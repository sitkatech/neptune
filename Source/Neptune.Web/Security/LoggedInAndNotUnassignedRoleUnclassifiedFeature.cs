/*-----------------------------------------------------------------------
<copyright file="LoggedInAndNotUnassignedRoleUnclassifiedFeature.cs" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
namespace Neptune.Web.Security
{
    ...
    public class LoggedInAndNotUnassignedRoleUnclassifiedFeature : NeptuneFeature
    {
        public LoggedInAndNotUnassignedRoleUnclassifiedFeature()
            : base(NeptuneBaseFeatureHelpers.AllRolesExceptUnassigned)
        {
        }
    }
}