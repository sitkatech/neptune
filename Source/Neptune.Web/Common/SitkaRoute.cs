...
namespace Neptune.Web.Common
{
    ...
    public class SitkaRoute<T> where T : Controller
    {
        ...
        // ReSharper restore StaticFieldInGenericType
        {
            ...
            var url = string.Format("http://{0}{1}", NeptuneWebConfiguration.CanonicalHostName, SitkaWebConfiguration.WebApplicationRootPath);
        ...
        public SitkaRoute(Expression<Action<T>> routeExpression) 
        {
            ...
            ControllerName = Neptune.Web.Common.SitkaController.ControllerTypeToControllerName(typeof(T));
        ...
        public static string BuildAbsoluteUrlFromRelativeUrl(string protocol, string relativeUrl)
        {
            ...
            var hostName = NeptuneWebConfiguration.CanonicalHostName;
            if (currentContext != null)
            {
                hostName = NeptuneWebConfiguration.GetCanonicalHost(currentContext.Request.Url.Host, true) ?? NeptuneWebConfiguration.CanonicalHostName;
            }
