// todo: this entire file may well end up going away, but I'm just trying to be as apples to apples as I can with the port for now.
...
namespace Neptune.Web.Views.Shared.ProjectLocationControls
{
    public class ProjectMapLegendElement
    {
        ...
        public static Dictionary<string, List<ProjectMapLegendElement>> BuildLegendFormatDictionary(List<object> topLevelTaxonomyTiers, bool showProposals)
        {
