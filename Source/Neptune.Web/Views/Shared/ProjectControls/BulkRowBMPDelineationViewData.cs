...
namespace Neptune.Web.Views.Shared.ProjectControls
{
    ...
    {
        public List<Models.Delineation> bmpDelineations { get; }
        public string BulkRowPostUrl { get; }
        public string EntityLabel { get;  }
        public string EntityModalDescription { get;  }

        public BulkRowBMPDelineationViewData(List<Models.Delineation> bmpDelineations, string bulkRowPostUrl, string entityLabel, string entityModalDescription)
        {
