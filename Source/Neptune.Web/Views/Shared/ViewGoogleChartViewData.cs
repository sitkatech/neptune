...
{
    public class ViewGoogleChartViewData : NeptuneUserControlViewData
    {
        ...
        public ViewGoogleChartViewData(GoogleChartJson googleChartJson,
            string chartTitle,
            int chartHeight,
            bool showChartTitle) : this(googleChartJson == null ? new List<GoogleChartJson>() : new List<GoogleChartJson> {googleChartJson},
            chartTitle,
            chartHeight,
            null,
            chartTitle.Replace(" ", ""),
