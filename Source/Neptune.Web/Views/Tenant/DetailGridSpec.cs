...
namespace Neptune.Web.Views.Tenant
{
    public class DetailGridSpec : GridSpec<Models.TenantAttribute>
    {
        public DetailGridSpec()
        {
            ...
            Add("Tenant Domain", t => string.Format("<a href=\"http://{0}\" target=\"_blank\">{0}</a>", NeptuneWebConfiguration.NeptuneEnvironment.GetCanonicalHostNameForEnvironment(t.Tenant)).ToHTMLFormattedString(), 200, DhtmlxGridColumnFilterType.Html);
