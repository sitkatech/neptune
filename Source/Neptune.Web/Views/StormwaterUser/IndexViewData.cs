...
namespace Neptune.Web.Views.StormwaterUser
{
    public class IndexViewData : NeptuneViewData
    {
        ...
        public IndexViewData(Person currentPerson, Models.NeptunePage neptunePage)
            : base(currentPerson, StormwaterBreadCrumbEntity.Users, neptunePage)
        {
            PageTitle = "All Users";
            GridSpec = new IndexGridSpec(currentPerson, HttpRequestStorage.DatabaseEntities.AllStormwaterJurisdictions.ToList().OrderBy(x => x.OrganizationDisplayName)) {ObjectNameSingular = "User", ObjectNamePlural = "Users", SaveFiltersInCookie = true};
            GridName = "UserGrid";
