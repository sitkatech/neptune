    ...
    public class IndexGridSpec : GridSpec<StormwaterJurisdiction>
    {
        public IndexGridSpec()
        {
            ...
            Add("Public BMP Visibility",
                x => x.StormwaterJurisdictionBMPPublicVisibilityType
                    .StormwaterJurisdictionBMPPublicVisibilityTypeDisplayName, 100, DhtmlxGridColumnFilterType.SelectFilterHtmlStrict);
