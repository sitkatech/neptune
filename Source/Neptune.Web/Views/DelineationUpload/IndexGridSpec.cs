...
namespace Neptune.Web.Views.DelineationUpload
{
    public class IndexGridSpec : GridSpec<Models.ModeledCatchment>
    {
        public IndexGridSpec(Person currentPerson)
        {
            ...
            Add(Models.FieldDefinition.Jurisdiction.ToGridHeaderString("Jurisdiction"), x => UrlTemplate.MakeHrefString(x.GetJurisdictionSummaryUrl(), x.StormwaterJurisdiction.GetOrganizationDisplayName()), 300, DhtmlxGridColumnFilterType.SelectFilterHtmlStrict);
