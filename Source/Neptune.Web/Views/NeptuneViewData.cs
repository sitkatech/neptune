...
namespace Neptune.Web.Views
{
    public abstract class NeptuneViewData
    {
        ...
        private static LtInfoMenuItem BuildBMPInventoryMenu(Person currentPerson)
        {
            ...
            bmpMenu.AddMenuItem(LtInfoMenuItem.MakeItem(new SitkaRoute<TreatmentBMPController>(c => c.TreatmentBMPAssessmentSummary()), currentPerson, "View Latest BMP Assessments", "Group1"));

            bmpMenu.AddMenuItem(LtInfoMenuItem.MakeItem(new SitkaRoute<FieldVisitController>(c => c.Index()), currentPerson, "View All Field Records Field Records", "Group2"));
