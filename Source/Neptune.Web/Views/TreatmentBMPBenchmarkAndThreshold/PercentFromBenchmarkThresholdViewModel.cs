...
{
    public class PercentFromBenchmarkThresholdViewModel : FormViewModel, IValidatableObject
    {
        ...
        /// </summary>
        public PercentFromBenchmarkThresholdViewModel()
        {
        }

        public PercentFromBenchmarkThresholdViewModel(Models.TreatmentBMP treatmentBMP, Models.ObservationType observationType)
        {
