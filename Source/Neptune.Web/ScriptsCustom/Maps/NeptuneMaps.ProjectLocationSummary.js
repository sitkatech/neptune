/*-----------------------------------------------------------------------
<copyright file="NeptuneMaps.ProjectLocationSummary.js" company="Tahoe Regional Planning Agency and Sitka Technology Group">
...
-----------------------------------------------------------------------*/
NeptuneMaps.ProjectLocationSummary = function(projectLocationSummaryMapInitJson,
    projectLocationInformationContainer) {
    NeptuneMaps.Map.call(this, projectLocationSummaryMapInitJson);
...
NeptuneMaps.ProjectLocationSummary.prototype = Sitka.Methods.clonePrototype(NeptuneMaps.Map.prototype);
