...
function getModalDialogFromHtmlTemplate(dialogDivId, dialogTitle, dialogContent, width, saveButtonText, saveButtonId, closeButtonText, closeButtonID)
{
    ...
    var modalDialogHtml =
    "<div class='modal neptune-modal' id='" + dialogDivId + "' tabindex='-1'>" +
        "<div class='modal-dialog neptune-modal-dialog' style = 'width:90%; max-width: " + width + "'>" +
            "<div class='modal-content'>" +
                ...
                "<div class='modal-footer'>" +
                    ...
                    "<div class='modal-footer-buttons'>" +
                        "<button type='button' id='" + saveButtonId + "' class='btn btn-xs btn-neptune'>" + saveButtonText + "</button>" +
                        "<button type='button' id='" + closeButtonID + "' class='btn btn-xs btn-neptune' data-dismiss='modal'>" + closeButtonText + "</button>" +
                    "</div>" +
                "</div>" +
