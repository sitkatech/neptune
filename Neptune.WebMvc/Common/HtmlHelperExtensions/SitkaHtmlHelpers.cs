...
namespace Neptune.WebMvc.Common.HtmlHelperExtensions
{
    public static class SitkaHtmlHelpers
    {
        ...
        /// </summary>
        private static readonly Regex NamespacesRegex = new(@".*WebMvc\.(?<NamespacesAfterWeb>.*)", RegexOptions.IgnoreCase);
