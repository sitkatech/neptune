...
namespace Neptune.WebMvc.Areas.Trash.Views.LandUseBlock
{
    public class IndexViewData : TrashModuleViewData
    {
        ...
        public IndexViewData(HttpContext httpContext, LinkGenerator linkGenerator, Person currentPerson, WebConfiguration webConfiguration, NeptunePage neptunePage, string landUseBlockBulkUploadUrl) : base (httpContext, linkGenerator, currentPerson, webConfiguration, neptunePage)
        {
