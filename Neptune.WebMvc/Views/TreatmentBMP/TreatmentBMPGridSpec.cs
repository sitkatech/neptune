...
namespace Neptune.WebMvc.Views.TreatmentBMP
{
    ...
    public class ViewTreatmentBMPModelingAttributesGridSpec : GridSpec<EFModels.Entities.TreatmentBMP>
    {
            ...
            Dictionary<int, vTreatmentBMPModelingAttribute> vTreatmentBmpModelingAttributesDict)
        {
            ...
            Add(FieldDefinitionType.TimeOfConcentrationID.ToGridHeaderString("Time Of Concentration (mins)"), x => (vTreatmentBmpModelingAttributesDict.TryGetValue(x.TreatmentBMPID, out var modelingAttributes) ? modelingAttributes.TimeOfConcentration : null) ?? string.Empty, 100, DhtmlxGridColumnFilterType.SelectFilterStrict);
