...
namespace Neptune.WebMvc.Views.TreatmentBMP
{
    ...
    public class ViewTreatmentBMPModelingAttributesGridSpec : GridSpec<EFModels.Entities.TreatmentBMP>
    {
            ...
            Dictionary<int, double?> treatmentBMPModeledLandUseAreas)
        {
            ...
            Add(FieldDefinitionType.MonthsOfOperationID.ToGridHeaderString("Months Operational"), x => x.TreatmentBMPModelingAttributeTreatmentBMP?.MonthsOfOperation != null ?x.TreatmentBMPModelingAttributeTreatmentBMP?.MonthsOfOperation.MonthsOfOperationDisplayName : string.Empty, 100, DhtmlxGridColumnFilterType.Html);
            ...
            Add(FieldDefinitionType.TimeOfConcentrationID.ToGridHeaderString("Time Of Concentration (mins)"), x => x.TreatmentBMPModelingAttributeTreatmentBMP?.TimeOfConcentrationID != null ? int.Parse(x.TreatmentBMPModelingAttributeTreatmentBMP.TimeOfConcentration.TimeOfConcentrationDisplayName) : null, 100, DhtmlxGridColumnFormatType.Integer);
            ...
            Add(FieldDefinitionType.UnderlyingHydrologicSoilGroupID.ToGridHeaderString("Underlying Hydrologic Soil Group"), x => x.TreatmentBMPModelingAttributeTreatmentBMP?.UnderlyingHydrologicSoilGroup != null ? x.TreatmentBMPModelingAttributeTreatmentBMP?.UnderlyingHydrologicSoilGroup.UnderlyingHydrologicSoilGroupDisplayName : string.Empty, 100, DhtmlxGridColumnFilterType.SelectFilterStrict);
            ...
            Add(FieldDefinitionType.UpstreamBMP.ToGridHeaderString("Upstream BMP"), x => x.UpstreamBMPID != null ? UrlTemplate.MakeHrefString(detailUrlTemplate.ParameterReplace(x.UpstreamBMPID.Value), x.UpstreamBMP.TreatmentBMPName) : new HtmlString(""), 170, DhtmlxGridColumnFilterType.Html);
