...
namespace Neptune.WebMvc.Views.TreatmentBMP
{
    ...
    public class ViewTreatmentBMPModelingAttributesGridSpec : GridSpec<EFModels.Entities.TreatmentBMP>
    {
            ...
            Dictionary<int, vTreatmentBMPModelingAttribute> vTreatmentBmpModelingAttributesDict)
        {
            ...
            Add(FieldDefinitionType.MonthsOfOperationID.ToGridHeaderString("Months Operational"), x => (vTreatmentBmpModelingAttributesDict.TryGetValue(x.TreatmentBMPID, out var modelingAttributes) ? modelingAttributes.ModeledMonthsOfOperation : null) ?? string.Empty, 100, DhtmlxGridColumnFilterType.Html);
            ...
            Add(FieldDefinitionType.WaterQualityDetentionVolume.ToGridHeaderString("Extended Detention Surcharge Volume (cu ft)"), x => vTreatmentBmpModelingAttributesDict.TryGetValue(x.TreatmentBMPID, out var modelingAttributes) ? modelingAttributes.WaterQualityDetentionVolume : null, 100, DhtmlxGridColumnFormatType.Decimal);
