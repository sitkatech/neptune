...
namespace Neptune.WebMvc.Views.OnlandVisualTrashAssessment
{
    public class OVTASectionViewData : TrashModuleViewData
    {
        ...
        public OVTASectionViewData(HttpContext httpContext, LinkGenerator linkGenerator, Person currentPerson, WebConfiguration webConfiguration, EFModels.Entities.NeptunePage neptunePage, Neptune.EFModels.Entities.OVTASection ovtaSection, Neptune.EFModels.Entities.OnlandVisualTrashAssessment? ovta) : base(httpContext, linkGenerator, currentPerson, webConfiguration, neptunePage)
        {
