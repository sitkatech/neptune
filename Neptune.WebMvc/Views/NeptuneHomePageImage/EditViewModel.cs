...
namespace Neptune.WebMvc.Views.NeptuneHomePageImage
{
    public class EditViewModel : FormViewModel
    {
        ...
        public EditViewModel(EFModels.Entities.NeptuneHomePageImage neptuneHomePageImage)
        {
            Caption = neptuneHomePageImage.Caption;
            SortOrder = neptuneHomePageImage.SortOrder;
        }

        public void UpdateModel(EFModels.Entities.NeptuneHomePageImage neptuneHomePageImage, Person person)
        {
